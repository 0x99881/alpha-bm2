...
class ApplicationService:
    ...
    def online_active_members(self) -> list[dict[str, str]]:
        rows = [
            row
            for row in self._online_member_rows()
    ...
    def online_score_summary_data(self) -> dict:
        members = self.online_active_members()
    ...
    def online_score_summary(self):
        summary = self.online_score_summary_data()
        return {
    ...
    def online_score_sheet_view(self):
        ...
        for member in members:
            ...
            raw_rows.append([*date_scores, sum(date_scores), 0.0, name])
    ...
    def mobile_overview(self) -> dict:
        return {
            "score_sheet_view": self.online_score_sheet_view(),
            "score_summary": self.online_score_summary(),
            "active_members": self.online_active_members(),
            "next_score_date": self.online_next_score_date(),
        }
