...
class StoreBaseMixin:
    def __init__(self, base_dir: Path) -> None:
        ...
        self.workbook_manager = WorkbookManager(self)
        self.workbook_manager.initialize_workbook()
    ...
    def add_member(self, name: str, note: str = '') -> None:
        ...
        workbook = self.workbook_manager.open_workbook()
        try:
            self.workbook_manager.sync_member_visibility(workbook)
            self.workbook_manager.save_workbook(workbook)
        finally:
            workbook.close()
    ...
    def delete_member(self, name: str) -> None:
        ...
        workbook = self.workbook_manager.open_workbook()
        try:
            self.workbook_manager.delete_member_data(workbook, name)
            self.workbook_manager.save_workbook(workbook)
        finally:
            workbook.close()
